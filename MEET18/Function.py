...
#   bodyFunction
def bahasa_asing( ba ):
    print(f"Brlajar di bahasa asing ( { ba } )")
bahasa_asing("coding")
batas()
...
print(f"hasil aritmatika = { aritmatika (4,)}")
h_tambah, h_kurang, h_kali, h_bagi, h_mod = aritmatika(4, 2)

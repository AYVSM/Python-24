#Type Hints :
#berguna untuk membuat Default Tips data pada variabel parameter Function.
def tambahan_100( z ):
    return 100 + z
...
print ( f" name : {yourName("ana", "Iola", "ina")}")
# print ( f"name : {yourName("ana", "Iola", "ina", "dede" )} ) # tdk bisa
batas()
def Bio( *data ):
    return data
print ( f" name args : {Bio( "ana", "Iola", "ina", "dede")}" )
batas()
def plusPlus( *data ):
    hasil = 0
    for i in data:
...
parameter1, parameter2, args, kwArgs = MixFinal( 1,2,3,4,5,6,7 )

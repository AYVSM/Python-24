...
print(f"Merk Mobil2 = { dataNest['mobil2'].get("color")}")

print("-"*15, "DEEPCOPY")
from copy import deepcopy
dataNest_copy = deepcopy(dataNest)
dataNest["mobil1"]["merk"] = "Xenia"
...
data1 = [ "x", "y", "z"]
data2 = [7, 8, 9]
dataFinal = { k : v for k,v in zip(data1, data2)}
